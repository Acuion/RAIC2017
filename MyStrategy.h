...
private:
	void firstTickActionsRound1(const Player& me, const World& world, const Game& game, Move& move);
	...
	xypoint mPanicPoint;
	int mLastNuke;
	groupTurnPrototype mInfinityChaseRound1;
	groupTurnPrototype mSmartChaseRound2;
